...
class MSNMessengerToolbars extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        <style>${MSNMessengerToolbars.styles}</style>
        <div class="container">
...
customElements.define("msn-messenger-toolbars", MSNMessengerToolbars);
